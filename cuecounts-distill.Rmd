...
```{r hist, fig.cap="Radial detection distances of winter wren song bursts."}
...
wrensong.hr <- ds(wren_cuecount, transect="point", key="hr", adjustment=NULL, 
                  truncation=100, convert_units = conversion.factor)
```
...
```{r fit, fig.cap="Fit of hazard rate detection function to winter wren song detection distances."}
...
```{r gof, fig.cap="Q-Q plot of hazard rate model to winter wren radial detection distances."}
gof_ds(wrensong.hr)
```
